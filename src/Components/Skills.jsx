        ...
        <section id='skills' className='skills'>
            ...
            <div className='skills_container'>
                ...
                <div className='card_skill'>
                    ...
                    <h3>CSS</h3>
                    <p>Buena experiencia y manejo para estilar los componentes para tu sitio web, diseños esteticos y completamente responsives</p>
                </div>

                <div className='card_skill'>
                    <i className='bx icon_skill bxl-react' ></i>
                    <h3>REACT JS</h3>
                    <p>Especializado en esta libreria para maquetar y añadir funcionalidades a tu sitio web para ofrecer un producto de mayor calidad.</p>
                </div>
